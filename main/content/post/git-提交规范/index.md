...
我在遵循该规范前，一致遵循 <https://gitmoji.dev/> 项目，在 emoji 的使用上，逐渐形成了自己的一套标准。直接的文字是不易一眼看出重点部分的，接下来我将结合 Gitmoji 和 Angular 规范做我自己的改造。
...
在 Angular 规范的基础上，以下几项是我个人添加的规范外部分但是我已经养成了习惯的：
...
另外，规范中 `refactor` 的类型较长，我将其精简到五个字符，不影响易读性。
