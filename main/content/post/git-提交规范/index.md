...
| **💄 appe**      | 外观更新或美化前端                | `:lipstick:` 添加或更新 UI 或样式文件          |
...
另外，规范中 `refactor` 的类型名较长，我将其精简到五个字符，不影响易读性。对于前端或样式的更改，其实我更喜欢 `🎨` 这个 emoji，不过在 gitmoji 中，该 emoji 被分配给了代码格式美化，为了保留两端的规范性，我最终还是选择了这个口红 emoji。
