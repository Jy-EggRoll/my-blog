...
- 直接更新对应的型号，不使用自动检测的软件，建议更新当前系统更新日期前的一个版本
- 当没有遇到任何显示问题时，比如奇怪的阴影闪烁，完全可以不更新显卡驱动。显卡驱动要秉持着能用就不更新的原则
- 目前，23H2 的十月更新配合 RedmiBookPro 的默认显卡驱动没有任何问题，非常稳定，而 24H2 和 25H2 在更新显卡驱动后依然存在一些小问题，比如在切换后台的界面帧率较低
