...
最近被微软拼音输入法整得很恼火，如果打一个长词，而只选中了部分文字，后面的候选框有概率直接消失，只有再变动一个字母才可以恢复（删除一个或者再多打一个），这也让我有了把输入法换掉的想法。
...
而且，随着不断地使用，自己的词库一旦被养成，就基本没有了什么和平台强捆绑的理由，这是因为拿到了明文的词库，将获得大量的可操作空间，不用再畏首畏尾。

## 更新

随着不断的使用，我的个人词库已经快要养成了，而且，借助 custom_phrase 功能，可以自定义一些词语的排序，这可以进一步养成肌肉记忆。从大小上来看，当前我的用户词不足 1 MB，即使如此，和我刚开始用 Rime 时，输入体验也已经发生了质变。
